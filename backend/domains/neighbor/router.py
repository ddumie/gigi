...
@router.get("/group-search/my", response_model=list[GroupSearchResponse]) # 나중에는 response_model에 루틴도 추가해야 함
...
@router.get("/feed/my", response_model=list[FeedPostResponse]) # 나중에는 response_model에 루틴도 추가해야 함
